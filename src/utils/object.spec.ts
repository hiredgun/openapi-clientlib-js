...
describe('utils object', () => {
    describe('extend', () => {
        ...
        it('copes with multiple arguments in shallow mode', () => {
            ...
            expect(
                extend({ fruit: { apple: true, banana: true } }, { fruit: {} }),
            ).toEqual({ fruit: {} });
        });
        it('allows null as a first argument to mean create a new object', () => {
            expect(extend(null, { banana: true }, { apple: true })).toEqual({
                banana: true,
                apple: true,
            });
        });
        describe('deep mode', () => {
            it('works without deep objects', () => {
                expect(
                    extend(true, {}, { banana: true }, { apple: true }),
