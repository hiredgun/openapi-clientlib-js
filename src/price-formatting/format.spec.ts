...
describe('price-formatting format', () => {
    it('passes basic tests', () => {
        ...
        expect(
            priceFormatting.format(42, 4, priceFormatOptions.Fractions),
        ).toEqual('42');

        expect(
            priceFormatting.format(42.0625, 4, priceFormatOptions.Fractions),
        ).toEqual('42\u00a01/16');

        expect(
            priceFormatting.format(42.125, 5, priceFormatOptions.Fractions),
        ).toEqual('42\u00a04/32');

        expect(
            priceFormatting.format(42.0625, 5, priceFormatOptions.Fractions),
        ).toEqual('42\u00a02/32');
    ...
    it('supports fractions', () => {
        for (let prec = 1; prec < 9; ++prec) {
            ...
            for (let d = 0; d <= n; ++d) {
                ...
                const text = priceFormatting.format(
                    val,
                    prec,
                    priceFormatOptions.Fractions,
                );
                const textadj = priceFormatting.format(val, prec, [
                    priceFormatOptions.AdjustFractions,
                    priceFormatOptions.Fractions,
                ]);
                const textwzf = priceFormatting.format(val, prec, [
                    priceFormatOptions.IncludeZeroFractions,
                    priceFormatOptions.Fractions,
                ]);
    ...
    it('Rounds up and down', () => {
        // Round down
        expect(
            priceFormatting.format(42.06249, 3, priceFormatOptions.Fractions),
        ).toEqual('42');

        expect(
            priceFormatting.format(42.06249, 3, [
                priceFormatOptions.IncludeZeroFractions,
                priceFormatOptions.Fractions,
            ]),
        ).toEqual('42\u00a00/8');
        ...
        expect(
            priceFormatting.format(42.0625, 3, priceFormatOptions.Fractions),
        ).toEqual('42\u00a01/8');

        // Round up
        expect(
            priceFormatting.format(42.18749, 3, priceFormatOptions.Fractions),
        ).toEqual('42\u00a01/8');

        expect(
            priceFormatting.format(42.1875, 3, priceFormatOptions.Fractions),
        ).toEqual('42\u00a02/8');
        ...
        ).toEqual('234,567\u00a0255/256');

        expect(
            priceFormatting.format(42.9999, 3, priceFormatOptions.Fractions),
        ).toEqual('43');

        expect(
            priceFormatting.format(42.9999, 3, [
                priceFormatOptions.IncludeZeroFractions,
                priceFormatOptions.Fractions,
            ]),
        ).toEqual('43\u00a00/8');
        ...
        expect(
            priceFormatting.format(234567.9999, 8, [
                priceFormatOptions.IncludeZeroFractions,
                priceFormatOptions.Fractions,
            ]),
        ).toEqual('234,568\u00a00/256');
    });
    ...
    it('supports special futures format - 1/32', () => {
        ...
        expect(
            priceFormatting.format(0, 5, priceFormatOptions.ModernFractions),
        ).toEqual("0'00");

        expect(
            priceFormatting.format(0, 5, priceFormatOptions.ModernFractions, 1),
        ).toEqual("0'00.0");

        expect(
            priceFormatting.format(0, 5, priceFormatOptions.ModernFractions, 2),
        ).toEqual("0'00.00");
    ...
    it('supports special futures format - 1/64', () => {
        ...
        // zero padding and digits
        expect(
            priceFormatting.format(0, 6, priceFormatOptions.ModernFractions),
        ).toEqual("0'00");

        expect(
            priceFormatting.format(0, 6, priceFormatOptions.ModernFractions, 1),
        ).toEqual("0'00.0");

        expect(
            priceFormatting.format(0, 6, priceFormatOptions.ModernFractions, 2),
        ).toEqual("0'00.00");
    ...
    it('supports percentage', () => {
        expect(
            priceFormatting.format(0.1233, 2, priceFormatOptions.Percentage),
        ).toEqual('12.33%');

        expect(
            priceFormatting.format(0, 2, priceFormatOptions.Percentage),
        ).toEqual('0.00%');
    });
    ...
    it('supports daDK culture', () => {
        ...
        expect(priceFormatting_da_dk.format(1234567.23451, 4)).toEqual(
            '1.234.567,2345',
        );

        expect(
            priceFormatting_da_dk.format(
                42.0625,
                4,
                priceFormatOptions.Fractions,
            ),
    ...
    it('supports frFR culture', () => {
        ...
        expect(priceFormatting_fr_fr.format(1234567.23451, 4)).toEqual(
            '1\u00a0234\u00a0567,2345',
        );

        expect(
            priceFormatting_fr_fr.format(
                42.0625,
                4,
                priceFormatOptions.Fractions,
            ),
    ...
    it('supports arEG culture', () => {
        ...
        expect(
            priceFormatting_ar_eg.format(1.23451, 4, priceFormatOptions.Normal),
        ).toEqual('1.2345');

        expect(
            priceFormatting_ar_eg.format(
                -1789.254,
                1,
        ...
        const parts = priceFormatting_ar_eg.formatPriceParts(-1.9876, 4);
    ...
    it('supports hiIN culture', () => {
        ...
        expect(priceFormatting_hi_in.format(1234567.23451, 4)).toEqual(
            '12,34,567.2345',
        );
    });
    ...
    it('supports formatting with deci-pips', () => {
        ...
        expect(
            priceFormatting.format(1789.22049, 2, [
                priceFormatOptions.AllowDecimalPips,
        ...
        expect(
            priceFormatting.format(1789.22549, 2, [
                priceFormatOptions.AllowDecimalPips,
                priceFormatOptions.DeciPipsDecimalSeparator,
            ]),
        ).toEqual('1,789.22.5');
        ...
        expect(
            priceFormatting.format(1789.22049, 2, [
                priceFormatOptions.AllowDecimalPips,
                priceFormatOptions.DeciPipsSpaceSeparator,
            ]),
        ).toEqual('1,789.22\u00a00');
        ...
        // FormatAsPips
        expect(
            priceFormatting.format(0.0023, 4, priceFormatOptions.FormatAsPips),
        ).toBe('23');

        expect(
            priceFormatting.format(0.00236, 4, priceFormatOptions.FormatAsPips),
        ).toBe('24');
        ...
        expect(
            priceFormatting.format(12.34, 4, priceFormatOptions.FormatAsPips),
        ).toBe('123,400');

        expect(
            priceFormatting.format(12.34, 2, priceFormatOptions.FormatAsPips),
        ).toBe('1,234');
        ...
        expect(
            priceFormatting.format(0.002384, 4, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.DeciPipsDecimalSeparator,
            ]),
        ).toEqual('0.0023.84');
        ...
        expect(
            priceFormatting.format(0.0023, 2, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.DeciPipsDecimalSeparator,
            ]),
        ).toEqual('0.00.23');
        ...
        expect(
            priceFormatting.format(0.00235, 4, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toEqual('23.50');
        ...
        expect(
            priceFormatting.format(1234.002384, 4, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('12,340,023.84');
        ...
        expect(
            priceFormatting.format(0.00001, 4, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('0.10');
        ...
        expect(
            priceFormatting.format(0.000001, 4, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('0.01');
        ...
        expect(
            priceFormatting.format(0.0000001, 4, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('0.00');
        ...
        expect(
            priceFormatting.format(0.235, 2, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toEqual('23.50');
        ...
        expect(
            priceFormatting.format(0.2384, 2, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('23.84');
        ...
        expect(
            priceFormatting.format(1234.2384, 2, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('123,423.84');
        ...
        expect(
            priceFormatting.format(0.001, 2, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('0.10');
        ...
        expect(
            priceFormatting.format(0.0001, 2, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('0.01');
        ...
        expect(
            priceFormatting.format(0.00001, 2, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('0.00');
        ...
        expect(
            priceFormatting_fr_fr.format(1234.002384, 4, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('12\u00a0340\u00a0023,84');
        ...
        expect(
            priceFormatting_fr_fr.format(1234.2384, 2, [
                priceFormatOptions.AllowTwoDecimalPips,
                priceFormatOptions.FormatAsPips,
            ]),
        ).toBe('123\u00a0423,84');
        ...
        expect(
            priceFormatting.format(46872.51, 0, [
                priceFormatOptions.AllowDecimalPips,
                priceFormatOptions.DeciPipsSpaceSeparator,
            ]),
        ).toEqual('46,872.5');
        ...
        expect(
            priceFormatting.format(1.91235, 4, [
                priceFormatOptions.DeciPipsFraction,
                priceFormatOptions.DeciPipsSpaceSeparator,
            ]),
        ).toEqual('1.9123\u00a0½');
        ...
        expect(
            priceFormatting.format(1.9123049, 4, [
                priceFormatOptions.DeciPipsFraction,
                priceFormatOptions.DeciPipsSpaceSeparator,
            ]),
        ).toEqual('1.9123\u00a00');
        ...
        expect(
            priceFormatting.format(1.9123749, 4, [
                priceFormatOptions.DeciPipsFraction,
                priceFormatOptions.DeciPipsSpaceSeparator,
            ]),
        ).toEqual('1.9123\u00a07');
        ...
        expect(
            priceFormatting.format(17893.0, 0, [
                priceFormatOptions.DeciPipsFraction,
                priceFormatOptions.DeciPipsSpaceSeparator,
            ]),
        ).toEqual('17,893\u00a00');
        ...
        expect(
            priceFormatting.format(17893.5, 0, [
                priceFormatOptions.DeciPipsFraction,
                priceFormatOptions.DeciPipsSpaceSeparator,
            ]),
        ).toEqual('17,893\u00a0½');
        ...
        expect(
            priceFormatting.format(17893.7, 0, [
                priceFormatOptions.DeciPipsFraction,
                priceFormatOptions.DeciPipsSpaceSeparator,
            ]),
        ).toEqual('17,893\u00a07');
    ...
    it('supports template', () => {
        expect(
            priceFormatting.formatTemplated(
                1.98765,
                4,
                priceFormatOptions.AllowDecimalPips,
            ),
        ).toEqual('1.9876<small>5</small>');
        expect(priceFormatting.formatTemplated(1.98765, 5)).toEqual(
            '1.98765<small></small>',
        );
    ...
    it('supports parts', () => {
        ...
        parts = priceFormatting.formatPriceParts(
            1.98765,
            4,
            priceFormatOptions.AllowDecimalPips,
        );
        ...
        parts = priceFormatting.formatPriceParts(1.98765, 4, [
            priceFormatOptions.DeciPipsDecimalSeparator,
            priceFormatOptions.AllowDecimalPips,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(123.56, 2, [
            priceFormatOptions.DeciPipsDecimalSeparator,
            priceFormatOptions.AllowDecimalPips,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(1543.15, 1, [
            priceFormatOptions.DeciPipsDecimalSeparator,
            priceFormatOptions.AllowDecimalPips,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(21091.5, 0, [
            priceFormatOptions.DeciPipsDecimalSeparator,
            priceFormatOptions.AllowDecimalPips,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(0, 0, [
            priceFormatOptions.DeciPipsFraction,
            priceFormatOptions.DeciPipsSpaceForZero,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(0.5, 0, [
            priceFormatOptions.DeciPipsFraction,
            priceFormatOptions.DeciPipsSpaceForZero,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(42.01, 3, [
            priceFormatOptions.IncludeZeroFractions,
            priceFormatOptions.Fractions,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(42.9999, 3, [
            priceFormatOptions.IncludeZeroFractions,
            priceFormatOptions.Fractions,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(42.00390625, 8, [
            priceFormatOptions.AdjustFractions,
            priceFormatOptions.Fractions,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(42.0, 8, [
            priceFormatOptions.AdjustFractions,
            priceFormatOptions.Fractions,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting_ar_eg.formatPriceParts(
            -0.00972999999999047,
            5,
            priceFormatOptions.Fractions,
        );
        ...
        parts = priceFormatting.formatPriceParts(123.23456, 4, [
            priceFormatOptions.AllowTwoDecimalPips,
            priceFormatOptions.FormatAsPips,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(1, 4, [
            priceFormatOptions.AllowTwoDecimalPips,
            priceFormatOptions.FormatAsPips,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(0.008899, 4, [
            priceFormatOptions.AllowTwoDecimalPips,
            priceFormatOptions.FormatAsPips,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(0.000001, 4, [
            priceFormatOptions.AllowTwoDecimalPips,
            priceFormatOptions.FormatAsPips,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(-1.234, 4, [
            priceFormatOptions.AllowTwoDecimalPips,
            priceFormatOptions.FormatAsPips,
        ]);
        expect(parts.Pre).toEqual('-');
        ...
        parts = priceFormatting_ar_eg.formatPriceParts(-1.234, 4, [
            priceFormatOptions.AllowTwoDecimalPips,
            priceFormatOptions.FormatAsPips,
        ]);
        expect(parts.Pre).toEqual('');
        ...
        parts = priceFormatting.formatPriceParts(0.18885, 4, [
            priceFormatOptions.AllowDecimalPips,
            priceFormatOptions.FormatAsPips,
        ]);
        expect(parts.Pre).toEqual('');
    ...
    it('supports no rounding options', () => {
        ...
        text = priceFormatting.format(1234.5678, 2, [
            priceFormatOptions.NoRounding,
            priceFormatOptions.AllowDecimalPips,
        ]);
        expect(text).toEqual('1,234.5678');

        text = priceFormatting.format(1234.5678, 3, [
            priceFormatOptions.NoRounding,
            priceFormatOptions.AllowDecimalPips,
        ]);
        expect(text).toEqual('1,234.5678');

        text = priceFormatting.format(1234.567, 3, [
            priceFormatOptions.NoRounding,
            priceFormatOptions.AllowDecimalPips,
        ]);
        ...
        text = priceFormatting.format(2567.90625, 5, [
            priceFormatOptions.NoRounding,
            priceFormatOptions.ModernFractions,
        ]);
        ...
        text = priceFormatting.format(
            1234.5000000003,
            5,
            [priceFormatOptions.NoRounding, priceFormatOptions.ModernFractions],
            1,
        );
