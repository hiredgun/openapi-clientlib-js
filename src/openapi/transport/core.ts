...
class Transport {
    ...
    private generateTransportCall(method: HTTPMethods) {
        return (servicePath?: string, urlTemplate?: string, templateArgs?: any, options?: TransportCoreOptions) => {
            let body;
            let headers: Record<string, string | number | boolean | null> = {};
